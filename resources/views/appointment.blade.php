...
<center>
  ...
  <hr>
    <div class="appform">
      ...
      <form method="POST" action="/storeappointment/{{$data['id']}}">
        {{ csrf_field() }}
...
@endif
          ...
          <div class="form-group">
                <label for="inputemail">Select Your Salon</label>
                <input type="text" class="form-control" id="inputemail" name="salon" aria-describedby="emailHelp" value="{{$data['Salon_name']}}">
          </div>
